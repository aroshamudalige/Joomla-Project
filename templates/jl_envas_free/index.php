    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                $toptx = ($this->helix3->PresetParam('_toptx')) ? $this->helix3->PresetParam('_toptx') : '#019bb6';
                $secondtx = ($this->helix3->PresetParam('_secondtx')) ? $this->helix3->PresetParam('_secondtx') : '#019bb6';
